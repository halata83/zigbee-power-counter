        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (channel == 2) {
                ...
                if (deltaTimeSec > 0 && deltaCount > 0) {
                    power = 1000 * (deltaCount / 10000) * (3600 / deltaTimeSec);
                }
                const energy = val / 10000;
...
const device = {
    zigbeeModel: ['power.counter'],
    model: 'power.counter',
    vendor: 'hatala.sytes',
    description: 'citac impulsu elektromeru na zaklade ptvo firmavare',
